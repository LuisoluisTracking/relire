  ...
  if (confirmed) {
    return (
      <div className="bg-white rounded-2xl border border-gray-100 p-8 text-center shadow-sm space-y-4">
        ...
        <h2 className="text-lg font-semibold" style={{ color: '#002F45' }}>Vérifiez votre email</h2>
        <p className="text-sm text-gray-500">
          Un lien de confirmation a été envoyé à <strong>{email}</strong>.<br />
          Cliquez dessus pour activer votre compte.
        </p>
        <Link href="/login" className="text-sm font-semibold" style={{ color: '#002F45' }}>
  ...
  return (
    <div>
      <div className="mb-8 text-center">
        <h1 className="text-2xl font-bold tracking-tight" style={{ color: '#002F45' }}>Relire</h1>
        <p className="text-sm text-gray-400 mt-1">Rejoignez la communauté de lecteurs</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm space-y-4">
        <div className="space-y-2">
          <button
            ...
            disabled={isPending}
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-lg border border-gray-200 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-60"
          >
            <GoogleIcon />
      ...
      <p className="text-center text-sm text-gray-400 mt-5">
        Déjà un compte ?{' '}
        <Link href="/login" className="font-semibold" style={{ color: '#002F45' }}>
          Se connecter
        </Link>
      </p>
    </div>
